...
public class UdflugtPane extends GridPane {
    ...
    private void createAction() {
      ...
      //  CreateUdflugt dia = new CreateUdflugt("Create Udflugt");
       // dia.showAndWait();
    ...
    private void tilmeldAction() {
        ...
        UdflugtWindow dia = new UdflugtWindow("Tilmeld ledsager");
        dia.showAndWait();
    }
    ...
    public void updateControls() {
        ...
        if (udflugt != null) {
            ...
            txfAdresse.setText(udflugt.getAdress());
            txfDato.setText(udflugt.getDate());
            txfPrice.setText("kr " + udflugt.getPrice());
